...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		Produto p11 = new Produto(null, "Shampoo", 180.00);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "eufrasio.daniel@gmail.com","36378912377" , TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "eufrasio.daniel@outlook.com","31628382740" , TipoCliente.PESSOAFISICA, pe.encode("123"));
